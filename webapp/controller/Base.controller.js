...
sap.ui.define([
	...
	"pnp/blockandreplace/util/ErrorHandler",
	"pnp/blockandreplace/util/uuid"
	...
	return Controller.extend("pnp.blockandreplace.controller.Base", {
		...
		//is valid loyalty card ID
		isValidLoyaltyCardID: function (sLoyaltyCardID) {

			//check for valid Loyalty card number
			if (!/[0-9]{16}/.test(sLoyaltyCardID) ||
				!/^735328/.test(sLoyaltyCardID) ||
				sLoyaltyCardID.length > 16) {
				return false;
			} else {
				return true;
			}
